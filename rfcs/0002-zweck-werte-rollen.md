# RFC-0002: Rollen der Organisation
...
Dieses Dokument beschreibt die Rollen innerhalb der Real Life Organisation. Zweck, Werte und Verhältnis zum Netzwerk sind in [RFC-0007](0007-organisation-und-netzwerk.md) definiert.

## Motivation

Die Organisation braucht klare Zuständigkeiten: Wenn ein Bug im Core ist, wenn ein Release ansteht, wenn eine Partnerschaft verhandelt wird, wenn ein Förderantrag eingereicht werden muss — es muss klar sein, wer sich darum kümmert. Im Gegensatz zum Netzwerk, das fluide und ohne feste Rollen funktioniert, organisiert die Organisation sich über feste Rollen mit klar abgegrenzten Verantwortungsbereichen.

## Rollen

Rollen definieren Zuständigkeiten. Wer eine Rolle hat, entscheidet eigenständig in seinem Bereich. Für Entscheidungen, die mehrere Bereiche betreffen, gilt der RFC-Prozess ([RFC-0001](0001-rfc-prozess.md)).
